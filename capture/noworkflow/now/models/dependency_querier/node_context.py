...
class NodeContext(object):
    ...
    def dependencies_forward(self):
        ...
        #ipdb.set_trace()
        for dep in self.options.dependencies_forward(evaluation):
    ...
    def dependencies_backward(self):
        ...
        # Follow default derivations
        for dep in self.options.dependencies_backward(evaluation):
            dependency = dep.dependency
            checkpoint = checkpoint or dependency.checkpoint
            if dep.type == 'argument' and not self.options.visit_arguments:
                continue
